...
//como a classe faz a simulação de um BD, não faz sentido utilizar mais de uma instância no pool de objetos
//@Singleton cria somente um objeto
@Singleton
/*Por padrão um EJB é carregado sob demanda (lazy), mas através da anotação
@Startup podemos definir que queremos usar o Singleton Bean desde o início da aplicação:*/
@Startup
public class Banco {
